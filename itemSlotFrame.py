...
class ItemslotframeWidget(tk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.itemIDEntry.grid(column=2, padx=3, row=0, sticky="ew")
        ...
        self.numGradeLabel.grid(column=0, pady=2, row=1)
        label2 = ttk.Label(self.itemBasicInfoFrame)
        label2.configure(text='增幅：')
        label2.grid(column=0, pady=2, row=2)
        ...
        self.numEntry.configure(width=16)
        self.numEntry.grid(column=1, row=1, sticky="ew")
        label5 = ttk.Label(self.itemBasicInfoFrame)
        label5.configure(text='耐久：')
        label5.grid(column=2, padx=3, row=1, sticky="w")
        self.durabilityEntry = ttk.Spinbox(self.itemBasicInfoFrame)
        self.durabilityEntry.configure(width=4)
        self.durabilityEntry.grid(column=2, padx=3, row=1, sticky="e")
        self.IncreaseTypeEntry = ttk.Combobox(self.itemBasicInfoFrame)
        self.IncreaseTypeEntry.configure(width=12)
        self.IncreaseTypeEntry.grid(column=1, row=2, sticky="ew")
        self.EnhanceEntry = ttk.Spinbox(self.itemBasicInfoFrame)
        self.EnhanceEntry.configure(width=16)
        self.EnhanceEntry.grid(column=1, pady=0, row=3, sticky="ew")
        self.forgingEntry = ttk.Spinbox(self.itemBasicInfoFrame)
        self.forgingEntry.configure(width=16)
        self.forgingEntry.grid(column=1, pady=0, row=4, sticky="ew")
        self.IncreaseEntry = ttk.Spinbox(self.itemBasicInfoFrame)
        self.IncreaseEntry.configure(width=12)
        self.IncreaseEntry.grid(column=2, padx=3, row=2, sticky="ew")
        self.delBtn = ttk.Button(self.itemBasicInfoFrame)
        self.delBtn.configure(text='删除')
        self.delBtn.grid(column=2, padx=3, row=3, sticky="ew")
        self.delBtn.configure(command=self.setDelete)
        self.resetBtn = ttk.Button(self.itemBasicInfoFrame)
        self.resetBtn.configure(text='重置')
        self.resetBtn.grid(column=2, padx=3, row=4, sticky="ew")
        ...
        label6.grid(column=0, columnspan=2, row=5, sticky="e")
        self.typeEntry = ttk.Combobox(self.itemBasicInfoFrame)
        self.typeEntry.configure(width=8)
        self.typeEntry.grid(column=2, padx=3, row=5, sticky="ew")
        self.typeEntry.bind(
            "<<ComboboxSelected>>",
        ...
        self.itemSlotBytesE.pack(expand="true", fill="x", padx=3, side="left")
        self.genBytesBtn = ttk.Button(self.btnFrame)
        self.genBytesBtn.configure(text='生成字节', width=8)
        self.genBytesBtn.pack(expand="true", fill="x", side="left")
        ...
        self.importBytesBtn.pack(expand="true", fill="x", side="left")
        ...
        self.commitBtn.pack(expand="true", fill="x", side="left")
